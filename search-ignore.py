...
def train(train_loader, valid_loader, model, architect, w_optim, alpha_optim, lr, epoch, Likelihood, Likelihood_optim):
    ...
    logger.info("size of train loader is {}".format(len(train_loader)))
    model.train()
    ...
    for step, ((trn_X, trn_y), (val_X, val_y)) in enumerate(zip(train_loader, valid_loader)):
        ...
        '''
        logger.info("logits = {}".format(logits.size()))
        logger.info("trn_y = {}".format(trn_y.size())) 
        logger.info("trn_y = {}".format(logits[0,:].unsqueeze(dim=0).size()))
        ...
        '''
        logger.info("loss = {}".format(loss)) 
        logger.info("Likelihood = {}, Likelihood sum={}, dataIndex = {}".format(Likelihood, Likelihood.sum(), dataIndex)) 
        '''
